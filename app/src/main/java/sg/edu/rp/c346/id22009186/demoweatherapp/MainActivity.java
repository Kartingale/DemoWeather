...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aaWeather = new WeatherAdapter(this, R.layout.simple_list_item_1, alWeather);
    ...
    protected void onResume() {
        ...
        client.get("https://api.data.gov.sg/v1/environment/2-hour-weather-forecast", new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                WeatherAdapter weatherAdapter = new WeatherAdapter(MainActivity.this, R.layout.simple_list_item_1, alWeather);
